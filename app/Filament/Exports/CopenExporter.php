...
class CopenExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ExportColumn::make('id')
                ->label('ID'),
            ExportColumn::make('code')->label(__('general.code')),
            ...
            ExportColumn::make('usage_limit')->label(__('general.usage_limit')),
    ...
    {
        $body = 'Your copen export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
